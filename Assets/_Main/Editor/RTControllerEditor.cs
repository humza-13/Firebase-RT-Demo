namespace Phoenix.Editor
{
    ...
    public class RTControllerEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            greenBoxStyle.normal.background = MakeTexture(1, 1, Color.grey);

            // Begin a vertical layout group with the green box style.
            EditorGUILayout.BeginVertical(greenBoxStyle);

            // Calculate the size of the label.
            GUIContent labelContent = new GUIContent("DB Controller");
            ...
            GUILayout.Label("DB Controller", labelStyle);
